    ...
    <div className="flex flex-col py-5 sm:flex-row justify-between max-w-[1360px] mx-auto items-center p-4 font-roboto">
      ...
      <div className="flex flex-col justify-between space-y-6">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <p className="text-md text-gray-500 font-normal leading-sung tracking-wide">
          ...
          <h3 className="text-center text-lg font-semibold italic tracking-wider leading-snug text-gray-800">
            Carefully written, extensively researched, simply understandable.
          </h3>
        </div>
      </div>
